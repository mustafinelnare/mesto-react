...
export default function Card(card) {
  ...
  const cardElementButtonClassName = (`element__button ${isLiked && 'element__button_active'}` 
  );
    ...
    <article className="element__item">
        ...
        <div className="element__description">
          ...
          <div className="element__place">
            <button className={cardElementButtonClassName} onClick={handleLikeClick} type="button"></button>
