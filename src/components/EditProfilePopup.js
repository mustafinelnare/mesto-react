...
return (
  <PopupWithForm name='edit' title='Редактировать профиль' button='Сохранить' isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit}>
  <input className="popup__input popup__input_type_name" type="text" id="nameInput" name="name" minLength="2"
    maxLength="40" placeholder="Имя пользователя" value={name} onChange={handleSetName} required/>
  ...
  <input className="popup__input popup__input_type_job" type="text" id="jobInput" name="job" minLength="2"
    maxLength="200" placeholder="Название профессии" value={description} onChange={handleSetDescription} required/>
